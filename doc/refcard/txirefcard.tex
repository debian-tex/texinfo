...
\centerline{Copyright \copyright\ 2024 Free Software Foundation, Inc.}
...
to this node.}
\txicmd{@nodedescriptionblock}{\dots\code{@end nodedescriptionblock}}{Provide description for menu references to this node across several lines.}
...
\txicmd{@link}{\ttbraced{node, \rmbrack[label], \rmbrack[manual]}}{Make a plain link, with no visible markup.  Does nothing for Info.}
...
\txicmd{@defblock}{\dots\code{@end ignore}}{Create a block that can contain definitions.}
\txicmd{@defline}{category name arguments}{Like \code{@deffn}, but without creating an index entry.}
\txicmd{@deftypeline}{category type name arguments}{Like \code{@deftypefn}, but without creating an index entry.}
...
\txicmd{@linemacro}{macroname \ttbraced{\var{params}} \dots\code{@end linemacro}}{Define a new Texinfo command using the rest of the line for arguments.}
