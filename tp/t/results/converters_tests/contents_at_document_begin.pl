...
$result_trees{'contents_at_document_begin'}{'contents'}[2]{'contents'}[3]{'contents'}[0]{'contents'}[1]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'contents_at_document_begin'}{'contents'}[2]{'contents'}[3]{'contents'}[0]{'contents'}[1]{'contents'}[0];
...
$result_sectioning{'contents_at_document_begin'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'contents_at_document_begin'}{'extra'}{'section_childs'}[0];
$result_sectioning{'contents_at_document_begin'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'toplevel_directions'}{'prev'} = $result_sectioning{'contents_at_document_begin'}{'extra'}{'section_childs'}[0];
$result_sectioning{'contents_at_document_begin'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'toplevel_directions'}{'up'} = $result_sectioning{'contents_at_document_begin'}{'extra'}{'section_childs'}[0];
$result_sectioning{'contents_at_document_begin'}{'extra'}{'section_childs'}[0]{'extra'}{'sectioning_root'} = $result_sectioning{'contents_at_document_begin'};
...
$result_nodes{'contents_at_document_begin'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'contents_at_document_begin'}[0];
$result_nodes{'contents_at_document_begin'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'contents_at_document_begin'}[0];
$result_nodes{'contents_at_document_begin'}[1] = $result_nodes{'contents_at_document_begin'}[0]{'extra'}{'node_directions'}{'next'};
...
$result_menus{'contents_at_document_begin'}[1]{'extra'}{'menu_directions'}{'up'} = $result_menus{'contents_at_document_begin'}[0];
