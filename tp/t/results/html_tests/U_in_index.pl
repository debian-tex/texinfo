...
$result_trees{'U_in_index'}{'contents'}[4]{'contents'}[1]{'extra'}{'element_node'} = $result_trees{'U_in_index'}{'contents'}[3];
$result_trees{'U_in_index'}{'contents'}[4]{'contents'}[3]{'extra'}{'element_node'} = $result_trees{'U_in_index'}{'contents'}[3];
$result_trees{'U_in_index'}{'contents'}[4]{'contents'}[5]{'extra'}{'element_node'} = $result_trees{'U_in_index'}{'contents'}[3];
...
<tr><td></td><td class="printindex-index-entry"><a href="#index-0074-letter-t">&#x0074; letter t</a></td><td class="printindex-index-section"><a href="#chap">chap</a></td></tr>
<tr><td></td><td class="printindex-index-entry"><a href="#index-00B5-greek-letter-mu">&#x00B5; greek letter mu</a></td><td class="printindex-index-section"><a href="#chap">chap</a></td></tr>
<tr><td></td><td class="printindex-index-entry"><a href="#index-0131-dotless-i">&#x0131; dotless i</a></td><td class="printindex-index-section"><a href="#chap">chap</a></td></tr>
<tr><td colspan="3"><hr></td></tr>
</table>
</div>
</div>
