...
$result_trees{'contents_at_end_separate_element'}{'contents'}[2]{'contents'}[3]{'contents'}[0]{'contents'}[1]{'extra'}{'node_content'}[0] = $result_trees{'contents_at_end_separate_element'}{'contents'}[2]{'contents'}[3]{'contents'}[0]{'contents'}[1]{'contents'}[0];
...
$result_nodes{'contents_at_end_separate_element'}{'structure'}{'menu_child'}{'structure'}{'node_prev'} = $result_nodes{'contents_at_end_separate_element'};
$result_nodes{'contents_at_end_separate_element'}{'structure'}{'menu_child'}{'structure'}{'node_up'} = $result_nodes{'contents_at_end_separate_element'};
$result_nodes{'contents_at_end_separate_element'}{'structure'}{'node_next'} = $result_nodes{'contents_at_end_separate_element'}{'structure'}{'menu_child'};
...
$result_menus{'contents_at_end_separate_element'}{'structure'}{'menu_child'}{'structure'}{'menu_up'} = $result_menus{'contents_at_end_separate_element'};
