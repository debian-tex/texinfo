...
$result_trees{'no_content_do_contents_separate_element'}{'contents'}[2]{'contents'}[3]{'contents'}[0]{'contents'}[1]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'no_content_do_contents_separate_element'}{'contents'}[2]{'contents'}[3]{'contents'}[0]{'contents'}[1]{'contents'}[0];
...
$result_sectioning{'no_content_do_contents_separate_element'}{'extra'}{'section_childs'}[0]{'extra'}{'sectioning_root'} = $result_sectioning{'no_content_do_contents_separate_element'};
...
$result_nodes{'no_content_do_contents_separate_element'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'no_content_do_contents_separate_element'}[0];
$result_nodes{'no_content_do_contents_separate_element'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'no_content_do_contents_separate_element'}[0];
$result_nodes{'no_content_do_contents_separate_element'}[1] = $result_nodes{'no_content_do_contents_separate_element'}[0]{'extra'}{'node_directions'}{'next'};
...
$result_menus{'no_content_do_contents_separate_element'}[1]{'extra'}{'menu_directions'}{'up'} = $result_menus{'no_content_do_contents_separate_element'}[0];
