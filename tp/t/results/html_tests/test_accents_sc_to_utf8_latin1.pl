...
$result_sectioning{'test_accents_sc_to_utf8_latin1'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'test_accents_sc_to_utf8_latin1'}{'extra'}{'section_childs'}[0];
$result_sectioning{'test_accents_sc_to_utf8_latin1'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'toplevel_directions'}{'prev'} = $result_sectioning{'test_accents_sc_to_utf8_latin1'}{'extra'}{'section_childs'}[0];
$result_sectioning{'test_accents_sc_to_utf8_latin1'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'toplevel_directions'}{'up'} = $result_sectioning{'test_accents_sc_to_utf8_latin1'}{'extra'}{'section_childs'}[0];
