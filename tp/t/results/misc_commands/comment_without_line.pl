...
$result_converted{'html_text'}->{'comment_without_line'} = '';


$result_converted{'latex'}->{'comment_without_line'} = '\\documentclass{book}
\\usepackage{amsfonts}
\\usepackage{amsmath}
...
$result_converted{'docbook'}->{'comment_without_line'} = '<!-- -->
';
