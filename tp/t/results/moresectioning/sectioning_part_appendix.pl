...
$result_trees{'sectioning_part_appendix'}[0]{'unit_contents'}[1] = $result_trees{'sectioning_part_appendix'}[0]{'unit_command'};
$result_trees{'sectioning_part_appendix'}[1]{'unit_contents'}[0] = $result_trees{'sectioning_part_appendix'}[1]{'unit_command'};
$result_trees{'sectioning_part_appendix'}[2]{'unit_contents'}[0] = $result_trees{'sectioning_part_appendix'}[2]{'unit_command'};
$result_trees{'sectioning_part_appendix'}[3]{'unit_contents'}[0] = $result_trees{'sectioning_part_appendix'}[3]{'unit_command'};
$result_trees{'sectioning_part_appendix'}[4]{'unit_contents'}[0] = $result_trees{'sectioning_part_appendix'}[4]{'unit_command'};
$result_trees{'sectioning_part_appendix'}[5]{'unit_contents'}[0] = $result_trees{'sectioning_part_appendix'}[5]{'unit_command'}{'extra'}{'associated_part'};
$result_trees{'sectioning_part_appendix'}[5]{'unit_contents'}[1] = $result_trees{'sectioning_part_appendix'}[5]{'unit_command'};
$result_trees{'sectioning_part_appendix'}[6]{'unit_contents'}[0] = $result_trees{'sectioning_part_appendix'}[6]{'unit_command'};
$result_trees{'sectioning_part_appendix'}[7]{'unit_contents'}[0] = $result_trees{'sectioning_part_appendix'}[7]{'unit_command'};
$result_trees{'sectioning_part_appendix'}[8]{'unit_contents'}[0] = $result_trees{'sectioning_part_appendix'}[8]{'unit_command'};
$result_trees{'sectioning_part_appendix'}[9]{'unit_contents'}[0] = $result_trees{'sectioning_part_appendix'}[9]{'unit_command'};
