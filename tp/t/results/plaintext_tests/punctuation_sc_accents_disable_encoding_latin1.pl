...
$result_trees{'punctuation_sc_accents_disable_encoding_latin1'}{'contents'}[1]{'extra'}{'node_content'}[0] = $result_trees{'punctuation_sc_accents_disable_encoding_latin1'}{'contents'}[1]{'args'}[0]{'contents'}[0];
$result_trees{'punctuation_sc_accents_disable_encoding_latin1'}{'contents'}[1]{'extra'}{'nodes_manuals'}[0]{'node_content'}[0] = $result_trees{'punctuation_sc_accents_disable_encoding_latin1'}{'contents'}[1]{'args'}[0]{'contents'}[0];
$result_trees{'punctuation_sc_accents_disable_encoding_latin1'}{'contents'}[3]{'extra'}{'node_content'}[0] = $result_trees{'punctuation_sc_accents_disable_encoding_latin1'}{'contents'}[3]{'args'}[0]{'contents'}[0];
$result_trees{'punctuation_sc_accents_disable_encoding_latin1'}{'contents'}[3]{'extra'}{'nodes_manuals'}[0]{'node_content'}[0] = $result_trees{'punctuation_sc_accents_disable_encoding_latin1'}{'contents'}[3]{'args'}[0]{'contents'}[0];

$result_texis{'punctuation_sc_accents_disable_encoding_latin1'} = '\\input texinfo
...
$result_texts{'punctuation_sc_accents_disable_encoding_latin1'} = '
top section
***********
...
$result_floats{'punctuation_sc_accents_disable_encoding_latin1'} = {};
