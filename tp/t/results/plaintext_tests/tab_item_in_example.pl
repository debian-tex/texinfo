...
$result_trees{'tab_item_in_example'}{'contents'}[0]{'contents'}[3]{'args'}[0]{'contents'}[0]{'extra'}{'command'} = $result_trees{'tab_item_in_example'}{'contents'}[0]{'contents'}[3];
...
$result_trees{'tab_item_in_example'}{'contents'}[0]{'contents'}[3]{'extra'}{'command'} = $result_trees{'tab_item_in_example'}{'contents'}[0];
