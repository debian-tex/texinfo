...
$l2h_cache_key = q/$\underline{\mathtt{math \hbox{ code }}} \sum_{i}{\underline{\mathit{eff}}}$/;
$l2h_cache{$l2h_cache_key} = q|<!-- MATH
 $\underline{\mathtt{math \hbox{ code }}} \sum_{i}{\underline{\mathit{eff}}}$
 -->
<SPAN CLASS="MATH"><IMG
 STYLE="height: 2.88ex; vertical-align: -1.03ex; " SRC="tex_10.svg"
 ALT="$\underline{\mathtt{math \hbox{ code }}} \sum_{i}{\underline{\mathit{eff}}}$"></SPAN>|;
...
<TD style="text-align:left;"><IMG
 ...
 ALT="$\displaystyle \mathtt{\acute{e}}$"></TD><TD class="rfill">(<SPAN CLASS="arabic">1</SPAN>)</TD></TR>
<TR><TD class="lfill"></TD><TD style="text-align:RIGHT"><IMG
...
<TD style="text-align:left;"><IMG
 ...
 ALT="$\displaystyle Y$"></TD><TD class="rfill">(<SPAN CLASS="arabic">2</SPAN>)</TD></TR>
</TABLE></DIV>|;
